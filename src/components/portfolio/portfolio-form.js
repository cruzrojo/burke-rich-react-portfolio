...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://burkemrich.devcamp.space/portfolio/portfolio_items",
      apiAction: 'post'
    };
          ...
          <div className="image-uploaders three-column">
            ...
            {this.state.thumb_image_url && this.state.editMode ? (
              <div className ="portfolio-manager-image-wrapper">
                <img src={this.state.thumb_image_url} alt="Image"/>
              ...
              <div className ="portfolio-manager-image-wrapper">
                <img src={this.state.banner_image_url} alt="Image"/>
              ...
              <div className ="portfolio-manager-image-wrapper">
                <img src={this.state.logo_url} alt="Image"/>
